...
const mockAnnouncements: Announcement[] = [
  {
    ...
    content: "The Assistive Tech Workshop has been rescheduled to April 21st at 2:30 PM. Please update your calendars accordingly.",
  ...
  {
    id: "3",
    title: "April Newsletter Published",
    content: "Check out our April newsletter featuring highlights from the Assistive Tech Workshop and Color Run events.",
